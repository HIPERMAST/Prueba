...
//			e.printStackTrace ();
	...
	//RF
	public void adicionarReservaServicioDehotel( )
    {
    	try 
    	{
    		String nombreServicio = JOptionPane.showInputDialog (this, "Nombre del servicio que quiere revisar?", "Agregar reserva", JOptionPane.QUESTION_MESSAGE);
