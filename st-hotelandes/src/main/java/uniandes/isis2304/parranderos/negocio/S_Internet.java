...
public class S_Internet implements VOS_Internet
{
	/* ****************************************************************
	 * 			Atributos
	 *****************************************************************/
	 ...
	 */
	public S_Internet(Integer idInternet, Integer capacidad, Boolean pagoCuenta, Integer costoServicio, Integer idHotel, Long idCliente) 
	{
	...
	{
		return "S_Internet [idInternet =" + idInternet + ", capacidad = " + capacidad + ", pagoCuenta = " + pagoCuenta + 
